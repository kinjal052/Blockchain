...
using Algorand_Console_Template1.Proxies;
using AlgoStudio.Clients;
using Proxies;
using System.Text;

namespace Algorand_Console_Template1
{
    internal class Program
    {
        ...
        static async Task Main(string[] args)
        {
          ...
          /*  ulong? splitPaymentApp = await DeploySplitPaymentApp(creator);
            ...
            ulong? HellowordBytesApp = await DeployHellowordProxy(creator);
            ...
            HellowordProxy hellowordProxy =new HellowordProxy(algodApiInstance, HellowordBytesApp.Value);
          ...
          /*  firstString = "aac";
            ...
            var Result = await hellowordProxy.Hello(creator, 2000, null, null);
        ...
        private static async Task<ulong?> DeployHellowordProxy(Account creator)
        {
